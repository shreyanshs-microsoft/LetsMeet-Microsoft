...
import LetsMeetMessageExtension from "../letsMeetMessageExtension/LetsMeetMessageExtension";
import { DialogSet, DialogState } from "botbuilder-dialogs";
// Initialize debug logging module
const log = debug("msteams");

/**
 * Implementation for LetsMeet Bot
 */
@BotDeclaration(
    "/api/messages",
    new MemoryStorage(),
...
export class LetsMeetBot extends TeamsActivityHandler {

    private readonly conversationState: ConversationState;
    /** Local property for LetsMeetMessageExtension */
    @MessageExtensionDeclaration("letsMeetMessageExtension")
    private _letsMeetMessageExtension: LetsMeetMessageExtension;
    ...
    public constructor(conversationState: ConversationState) {
        super();
        // Message extension LetsMeetMessageExtension
        this._letsMeetMessageExtension = new LetsMeetMessageExtension();
