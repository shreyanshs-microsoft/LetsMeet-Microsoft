...
3. Give the bot a handle (ex: `letsMeetBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://messageextensionfhl.azurewebsites.net/api/messages`
